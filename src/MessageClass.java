...
public class MessageClass {
    ...
    private Object RegisterPane;
    
    
    public MessageClass(String id, JTextField cellnumberField, String recipient, String message, String timestamp) {
        this.messageID = id;
        this.recipient = recipient;
        this.message = message;
    }

    MessageClass(String username) {
    ...
    while (true) { 
        String optionPicker = JOptionPane.showInputDialog(null, "Welcome to the QuickChat\n" + "1. Send Messages\n" + "2. Show Recently Sent Messages\n" + "3. Quit","QuickChat Menu",JOptionPane.QUESTION_MESSAGE );
            ...
            case "1": // Send Messages
                try {
                    ...
                    for (int i = 0; i < messageCount; i++) {
                        ...
                        MessageClass currentMessage = new MessageClass(messageID,Register1.cellnumber, content, sender, timestamp);
    ...
    private static class JSONArray {
        ...
        private void add(JSONObject messageObject) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
    ...
    private static class MessageClassng {

        public MessageClassng() {
        }
    }
