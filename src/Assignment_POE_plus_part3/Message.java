...
public class Message  {
    ...
    public Message(String recipient, String message, String flag, String hash){
    ...
    public Message(String hash, String recipient, String message) {
    ...
    while (true) { 
        ...
        switch (optionPicker) {
            ...
            case "2": 
                ...
                Collection<Message> messages = manager.getMessage().values();
                
                StringBuilder allMessages = new StringBuilder();
                for (Message msg : messages){
                    allMessages.append("To: ").append(msg.getRecipient()).append("\n")
